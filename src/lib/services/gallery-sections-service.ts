...
import { GallerySectionImage, GallerySection, GalleryImage } from "@/types/gallery";
...
function convertDbToGallerySectionImage(
  dbSection: DbGallerySection & {
    image_url: string;
    image_name: string;
...
export class GallerySectionsService {
  ...
  static async addImageToSection(
    ...
    const { error } = await supabase.from("establishment_gallery_sections").insert({
   ...
   */
  static async removeImageFromSection(sectionId: string, organizationId: string): Promise<void> {
   ...
   */
  static async reorderSectionImages(sectionImages: GallerySectionImage[], organizationId: string): Promise<void> {
   ...
   */
  static async getAvailableImages(establishmentId: string, organizationId?: string): Promise<GalleryImage[]> {
    let query = supabase
