...
ALTER TABLE "public"."crm_pre_invoice_seq" OWNER TO "postgres";
...
ALTER TABLE "public"."crm_quote_seq" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."crm_quotes" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "deleted" boolean DEFAULT false NOT NULL,
    CONSTRAINT "crm_quotes_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'sent'::"text", 'signed'::"text", 'rejected'::"text"])))
);
...
CREATE POLICY "nf525_jet_delete_universal" ON "public"."nf525_jet" FOR DELETE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_jet_insert_universal" ON "public"."nf525_jet" FOR INSERT TO "authenticated" WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_jet_update_universal" ON "public"."nf525_jet" FOR UPDATE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id")) WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_pieces_delete_universal" ON "public"."nf525_pieces" FOR DELETE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_pieces_insert_universal" ON "public"."nf525_pieces" FOR INSERT TO "authenticated" WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_pieces_update_universal" ON "public"."nf525_pieces" FOR UPDATE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id")) WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_restitutions_delete_universal" ON "public"."nf525_restitutions" FOR DELETE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_restitutions_insert_universal" ON "public"."nf525_restitutions" FOR INSERT TO "authenticated" WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_restitutions_update_universal" ON "public"."nf525_restitutions" FOR UPDATE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id")) WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_sequences_delete_universal" ON "public"."nf525_sequences" FOR DELETE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_sequences_insert_universal" ON "public"."nf525_sequences" FOR INSERT TO "authenticated" WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_sequences_update_universal" ON "public"."nf525_sequences" FOR UPDATE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id")) WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_signing_keys_delete_universal" ON "public"."nf525_signing_keys" FOR DELETE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_signing_keys_insert_universal" ON "public"."nf525_signing_keys" FOR INSERT TO "authenticated" WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "nf525_signing_keys_update_universal" ON "public"."nf525_signing_keys" FOR UPDATE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id")) WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "order_refunds_delete_universal" ON "public"."order_refunds" FOR DELETE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "order_refunds_insert_universal" ON "public"."order_refunds" FOR INSERT TO "authenticated" WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "order_refunds_select_universal" ON "public"."order_refunds" FOR SELECT TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
CREATE POLICY "order_refunds_update_universal" ON "public"."order_refunds" FOR UPDATE TO "authenticated" USING ("public"."auth_can_access_establishment"("organization_id", "establishment_id")) WITH CHECK ("public"."auth_can_access_establishment"("organization_id", "establishment_id"));
...
GRANT ALL ON TABLE "public"."crm_commercial_objectives" TO "anon";
GRANT ALL ON TABLE "public"."crm_commercial_objectives" TO "authenticated";
GRANT ALL ON TABLE "public"."crm_commercial_objectives" TO "service_role";



GRANT ALL ON TABLE "public"."crm_onboarding_checklists" TO "anon";
GRANT ALL ON TABLE "public"."crm_onboarding_checklists" TO "authenticated";
GRANT ALL ON TABLE "public"."crm_onboarding_checklists" TO "service_role";



GRANT ALL ON TABLE "public"."crm_onboarding_steps" TO "anon";
GRANT ALL ON TABLE "public"."crm_onboarding_steps" TO "authenticated";
GRANT ALL ON TABLE "public"."crm_onboarding_steps" TO "service_role";



GRANT ALL ON TABLE "public"."crm_pre_invoice_installments" TO "anon";
GRANT ALL ON TABLE "public"."crm_pre_invoice_installments" TO "authenticated";
GRANT ALL ON TABLE "public"."crm_pre_invoice_installments" TO "service_role";
...
GRANT ALL ON TABLE "public"."crm_pre_invoices" TO "anon";
GRANT ALL ON TABLE "public"."crm_pre_invoices" TO "authenticated";
GRANT ALL ON TABLE "public"."crm_pre_invoices" TO "service_role";
...
GRANT ALL ON TABLE "public"."crm_subscriptions" TO "anon";
GRANT ALL ON TABLE "public"."crm_subscriptions" TO "authenticated";
GRANT ALL ON TABLE "public"."crm_subscriptions" TO "service_role";
