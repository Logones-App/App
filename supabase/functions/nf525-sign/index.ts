// Edge Function nf525-sign — signe un événement JET (130/180/290/410) en ECDSA P-256 et l'insère,
...
const NON_PURGEABLE = new Set([410]); // 410 = données assujetti ; 130/180/290 = Journal Technique purgeable
