...
CREATE OR REPLACE TRIGGER "update_order_refunds_updated_at" BEFORE UPDATE ON "public"."order_refunds" FOR EACH ROW EXECUTE FUNCTION "public"."handle_updated_at"();
...
CREATE POLICY "doc_imports_delete_universal" ON "public"."doc_imports" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "doc_imports_insert_universal" ON "public"."doc_imports" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "doc_imports_select_universal" ON "public"."doc_imports" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "doc_imports_update_universal" ON "public"."doc_imports" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "employee_absences_delete_universal" ON "public"."employee_absences" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_absences_insert_universal" ON "public"."employee_absences" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_absences_select_universal" ON "public"."employee_absences" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_absences_update_universal" ON "public"."employee_absences" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "employee_module_access_delete_universal" ON "public"."employee_module_access" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_module_access_insert_universal" ON "public"."employee_module_access" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_module_access_select_universal" ON "public"."employee_module_access" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_module_access_update_universal" ON "public"."employee_module_access" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "employee_monthly_reports_delete_universal" ON "public"."employee_monthly_reports" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_monthly_reports_insert_universal" ON "public"."employee_monthly_reports" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_monthly_reports_select_universal" ON "public"."employee_monthly_reports" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_monthly_reports_update_universal" ON "public"."employee_monthly_reports" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "employee_permissions_delete_universal" ON "public"."employee_permissions" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_permissions_insert_universal" ON "public"."employee_permissions" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_permissions_select_universal" ON "public"."employee_permissions" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_permissions_update_universal" ON "public"."employee_permissions" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "employee_shift_overrides_delete_universal" ON "public"."employee_shift_overrides" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_shift_overrides_insert_universal" ON "public"."employee_shift_overrides" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_shift_overrides_select_universal" ON "public"."employee_shift_overrides" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employee_shift_overrides_update_universal" ON "public"."employee_shift_overrides" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "employee_shift_templates_delete_universal" ON "public"."employee_shift_templates" FOR DELETE TO "authenticated" USING (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
     JOIN "public"."users_organizations" ON (("establishments"."organization_id" = "users_organizations"."organization_id")))
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false) AND ("establishments"."deleted" = false)))));
...
CREATE POLICY "employee_shift_templates_insert_universal" ON "public"."employee_shift_templates" FOR INSERT TO "authenticated" WITH CHECK (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
     JOIN "public"."users_organizations" ON (("establishments"."organization_id" = "users_organizations"."organization_id")))
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false) AND ("establishments"."deleted" = false)))));
...
CREATE POLICY "employee_shift_templates_select_universal" ON "public"."employee_shift_templates" FOR SELECT TO "authenticated" USING (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
     JOIN "public"."users_organizations" ON (("establishments"."organization_id" = "users_organizations"."organization_id")))
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false) AND ("establishments"."deleted" = false)))));
...
CREATE POLICY "employee_shift_templates_update_universal" ON "public"."employee_shift_templates" FOR UPDATE TO "authenticated" USING (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
     JOIN "public"."users_organizations" ON (("establishments"."organization_id" = "users_organizations"."organization_id")))
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false) AND ("establishments"."deleted" = false))))) WITH CHECK (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
...
CREATE POLICY "employee_shifts_delete_universal" ON "public"."employee_shifts" FOR DELETE TO "authenticated" USING (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
     JOIN "public"."users_organizations" ON (("establishments"."organization_id" = "users_organizations"."organization_id")))
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false) AND ("establishments"."deleted" = false)))));
...
CREATE POLICY "employee_shifts_insert_universal" ON "public"."employee_shifts" FOR INSERT TO "authenticated" WITH CHECK (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
     JOIN "public"."users_organizations" ON (("establishments"."organization_id" = "users_organizations"."organization_id")))
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false) AND ("establishments"."deleted" = false)))));
...
CREATE POLICY "employee_shifts_select_universal" ON "public"."employee_shifts" FOR SELECT TO "authenticated" USING (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
     JOIN "public"."users_organizations" ON (("establishments"."organization_id" = "users_organizations"."organization_id")))
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false) AND ("establishments"."deleted" = false)))));
...
CREATE POLICY "employee_shifts_update_universal" ON "public"."employee_shifts" FOR UPDATE TO "authenticated" USING (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
     JOIN "public"."users_organizations" ON (("establishments"."organization_id" = "users_organizations"."organization_id")))
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false) AND ("establishments"."deleted" = false))))) WITH CHECK (("establishment_id" IN ( SELECT "establishments"."id"
   FROM ("public"."establishments"
...
CREATE POLICY "employees_delete_universal" ON "public"."employees" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employees_insert_universal" ON "public"."employees" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employees_select_universal" ON "public"."employees" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "employees_update_universal" ON "public"."employees" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "establishment_documents_delete_universal" ON "public"."establishment_documents" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "establishment_documents_insert_universal" ON "public"."establishment_documents" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "establishment_documents_select_universal" ON "public"."establishment_documents" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "establishment_documents_update_universal" ON "public"."establishment_documents" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "establishment_modules_delete_universal" ON "public"."establishment_modules" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "establishment_modules_insert_universal" ON "public"."establishment_modules" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "establishment_modules_select_universal" ON "public"."establishment_modules" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "establishment_modules_update_universal" ON "public"."establishment_modules" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "public_menu_sections_delete_universal" ON "public"."public_menu_sections" FOR DELETE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "public_menu_sections_insert_universal" ON "public"."public_menu_sections" FOR INSERT TO "authenticated" WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "public_menu_sections_select_universal" ON "public"."public_menu_sections" FOR SELECT TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));



CREATE POLICY "public_menu_sections_update_universal" ON "public"."public_menu_sections" FOR UPDATE TO "authenticated" USING (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false))))) WITH CHECK (("organization_id" IN ( SELECT "users_organizations"."organization_id"
   FROM "public"."users_organizations"
  WHERE (("users_organizations"."user_id" = ((("current_setting"('request.jwt.claims'::"text", true))::"json" ->> 'sub'::"text"))::"uuid") AND ("users_organizations"."deleted" = false)))));
...
CREATE POLICY "support_tickets_insert_universal" ON "public"."support_tickets" FOR INSERT WITH CHECK (true);



CREATE POLICY "support_tickets_select_universal" ON "public"."support_tickets" FOR SELECT TO "authenticated" USING ((((("current_setting"('request.jwt.claims'::"text", true))::"json" -> 'app_metadata'::"text") ->> 'role'::"text") = 'system_admin'::"text"));



CREATE POLICY "support_tickets_update_universal" ON "public"."support_tickets" FOR UPDATE TO "authenticated" USING ((((("current_setting"('request.jwt.claims'::"text", true))::"json" -> 'app_metadata'::"text") ->> 'role'::"text") = 'system_admin'::"text")) WITH CHECK (true);
...
GRANT ALL ON TABLE "public"."booking_table_allocations" TO "anon";
GRANT ALL ON TABLE "public"."booking_table_allocations" TO "authenticated";
GRANT ALL ON TABLE "public"."booking_table_allocations" TO "service_role";
...
GRANT ALL ON TABLE "public"."category_grid_items" TO "anon";
GRANT ALL ON TABLE "public"."category_grid_items" TO "authenticated";
GRANT ALL ON TABLE "public"."category_grid_items" TO "service_role";
...
GRANT ALL ON TABLE "public"."daily_found" TO "anon";
GRANT ALL ON TABLE "public"."daily_found" TO "authenticated";
GRANT ALL ON TABLE "public"."daily_found" TO "service_role";
...
GRANT ALL ON TABLE "public"."doc_import_corrections" TO "anon";
GRANT ALL ON TABLE "public"."doc_import_corrections" TO "authenticated";
GRANT ALL ON TABLE "public"."doc_import_corrections" TO "service_role";



GRANT ALL ON TABLE "public"."doc_import_lines" TO "anon";
GRANT ALL ON TABLE "public"."doc_import_lines" TO "authenticated";
GRANT ALL ON TABLE "public"."doc_import_lines" TO "service_role";



GRANT ALL ON TABLE "public"."doc_import_usage" TO "anon";
GRANT ALL ON TABLE "public"."doc_import_usage" TO "authenticated";
GRANT ALL ON TABLE "public"."doc_import_usage" TO "service_role";



GRANT ALL ON TABLE "public"."doc_imports" TO "anon";
GRANT ALL ON TABLE "public"."doc_imports" TO "authenticated";
GRANT ALL ON TABLE "public"."doc_imports" TO "service_role";
...
GRANT ALL ON TABLE "public"."employee_module_access" TO "anon";
GRANT ALL ON TABLE "public"."employee_module_access" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_module_access" TO "service_role";



GRANT ALL ON TABLE "public"."employee_monthly_reports" TO "anon";
GRANT ALL ON TABLE "public"."employee_monthly_reports" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_monthly_reports" TO "service_role";
...
GRANT ALL ON TABLE "public"."employee_shift_overrides" TO "anon";
GRANT ALL ON TABLE "public"."employee_shift_overrides" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_shift_overrides" TO "service_role";



GRANT ALL ON TABLE "public"."employee_shift_templates" TO "anon";
GRANT ALL ON TABLE "public"."employee_shift_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."employee_shift_templates" TO "service_role";
...
GRANT ALL ON TABLE "public"."establishment_documents" TO "anon";
GRANT ALL ON TABLE "public"."establishment_documents" TO "authenticated";
GRANT ALL ON TABLE "public"."establishment_documents" TO "service_role";



GRANT ALL ON TABLE "public"."establishment_gallery" TO "anon";
GRANT ALL ON TABLE "public"."establishment_gallery" TO "authenticated";
GRANT ALL ON TABLE "public"."establishment_gallery" TO "service_role";



GRANT ALL ON TABLE "public"."establishment_gallery_sections" TO "anon";
GRANT ALL ON TABLE "public"."establishment_gallery_sections" TO "authenticated";
GRANT ALL ON TABLE "public"."establishment_gallery_sections" TO "service_role";



GRANT ALL ON TABLE "public"."establishment_modules" TO "anon";
GRANT ALL ON TABLE "public"."establishment_modules" TO "authenticated";
GRANT ALL ON TABLE "public"."establishment_modules" TO "service_role";
...
GRANT ALL ON TABLE "public"."formula_products" TO "anon";
GRANT ALL ON TABLE "public"."formula_products" TO "authenticated";
GRANT ALL ON TABLE "public"."formula_products" TO "service_role";



GRANT ALL ON TABLE "public"."formula_slots" TO "anon";
GRANT ALL ON TABLE "public"."formula_slots" TO "authenticated";
GRANT ALL ON TABLE "public"."formula_slots" TO "service_role";
...
GRANT ALL ON TABLE "public"."menu_schedules" TO "anon";
GRANT ALL ON TABLE "public"."menu_schedules" TO "authenticated";
GRANT ALL ON TABLE "public"."menu_schedules" TO "service_role";
...
GRANT ALL ON TABLE "public"."menus_products" TO "anon";
GRANT ALL ON TABLE "public"."menus_products" TO "authenticated";
GRANT ALL ON TABLE "public"."menus_products" TO "service_role";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."menus_products" TO "e8d33df2-5a44-40b7-95c2-1b0cbc29838e";



GRANT ALL ON TABLE "public"."menus_products_price_history" TO "anon";
GRANT ALL ON TABLE "public"."menus_products_price_history" TO "authenticated";
GRANT ALL ON TABLE "public"."menus_products_price_history" TO "service_role";
...
GRANT ALL ON TABLE "public"."nf525_config" TO "anon";
GRANT ALL ON TABLE "public"."nf525_config" TO "authenticated";
GRANT ALL ON TABLE "public"."nf525_config" TO "service_role";



GRANT ALL ON TABLE "public"."nf525_jet" TO "anon";
GRANT ALL ON TABLE "public"."nf525_jet" TO "authenticated";
GRANT ALL ON TABLE "public"."nf525_jet" TO "service_role";



GRANT ALL ON TABLE "public"."nf525_piece_recap_tva" TO "anon";
GRANT ALL ON TABLE "public"."nf525_piece_recap_tva" TO "authenticated";
GRANT ALL ON TABLE "public"."nf525_piece_recap_tva" TO "service_role";



GRANT ALL ON TABLE "public"."nf525_pieces" TO "anon";
GRANT ALL ON TABLE "public"."nf525_pieces" TO "authenticated";
GRANT ALL ON TABLE "public"."nf525_pieces" TO "service_role";



GRANT ALL ON TABLE "public"."nf525_restitutions" TO "anon";
GRANT ALL ON TABLE "public"."nf525_restitutions" TO "authenticated";
GRANT ALL ON TABLE "public"."nf525_restitutions" TO "service_role";



GRANT ALL ON TABLE "public"."nf525_sequences" TO "anon";
GRANT ALL ON TABLE "public"."nf525_sequences" TO "authenticated";
GRANT ALL ON TABLE "public"."nf525_sequences" TO "service_role";



GRANT ALL ON TABLE "public"."nf525_signing_keys" TO "anon";
GRANT ALL ON TABLE "public"."nf525_signing_keys" TO "authenticated";
GRANT ALL ON TABLE "public"."nf525_signing_keys" TO "service_role";
...
GRANT ALL ON TABLE "public"."opening_hours_exceptions" TO "anon";
GRANT ALL ON TABLE "public"."opening_hours_exceptions" TO "authenticated";
GRANT ALL ON TABLE "public"."opening_hours_exceptions" TO "service_role";



GRANT ALL ON TABLE "public"."order_formulas" TO "anon";
GRANT ALL ON TABLE "public"."order_formulas" TO "authenticated";
GRANT ALL ON TABLE "public"."order_formulas" TO "service_role";



GRANT ALL ON TABLE "public"."order_payment_pools" TO "anon";
GRANT ALL ON TABLE "public"."order_payment_pools" TO "authenticated";
GRANT ALL ON TABLE "public"."order_payment_pools" TO "service_role";



GRANT ALL ON TABLE "public"."order_payment_settlements" TO "anon";
GRANT ALL ON TABLE "public"."order_payment_settlements" TO "authenticated";
GRANT ALL ON TABLE "public"."order_payment_settlements" TO "service_role";
...
GRANT ALL ON TABLE "public"."order_payments_rows" TO "anon";
GRANT ALL ON TABLE "public"."order_payments_rows" TO "authenticated";
GRANT ALL ON TABLE "public"."order_payments_rows" TO "service_role";
...
GRANT ALL ON TABLE "public"."order_suites" TO "anon";
GRANT ALL ON TABLE "public"."order_suites" TO "authenticated";
GRANT ALL ON TABLE "public"."order_suites" TO "service_role";
...
GRANT ALL ON TABLE "public"."product_option_group_products" TO "anon";
GRANT ALL ON TABLE "public"."product_option_group_products" TO "authenticated";
GRANT ALL ON TABLE "public"."product_option_group_products" TO "service_role";



GRANT ALL ON TABLE "public"."product_option_group_values" TO "anon";
GRANT ALL ON TABLE "public"."product_option_group_values" TO "authenticated";
GRANT ALL ON TABLE "public"."product_option_group_values" TO "service_role";
...
GRANT ALL ON TABLE "public"."product_purchase_price_history" TO "anon";
GRANT ALL ON TABLE "public"."product_purchase_price_history" TO "authenticated";
GRANT ALL ON TABLE "public"."product_purchase_price_history" TO "service_role";
...
GRANT ALL ON TABLE "public"."public_menu_sections" TO "anon";
GRANT ALL ON TABLE "public"."public_menu_sections" TO "authenticated";
GRANT ALL ON TABLE "public"."public_menu_sections" TO "service_role";
...
GRANT ALL ON TABLE "public"."support_knowledge_base" TO "anon";
GRANT ALL ON TABLE "public"."support_knowledge_base" TO "authenticated";
GRANT ALL ON TABLE "public"."support_knowledge_base" TO "service_role";
...
GRANT ALL ON TABLE "public"."tables_connections" TO "anon";
GRANT ALL ON TABLE "public"."tables_connections" TO "authenticated";
GRANT ALL ON TABLE "public"."tables_connections" TO "service_role";
...
GRANT ALL ON TABLE "public"."vat_rate" TO "anon";
GRANT ALL ON TABLE "public"."vat_rate" TO "authenticated";
GRANT ALL ON TABLE "public"."vat_rate" TO "service_role";
